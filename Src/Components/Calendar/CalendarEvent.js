...
const CalendarEvent = memo(({data, buttonColor, textColor, fontSize, onSelect, ...props}) => {
    ...
    return <Column >
        <Row style={{justifyContent:"space-between", alignItems:"center", paddingHorizontal:textPaddingHorizontal, marginBottom:10}}>
            <Texts style={{color:textColor, fontSize:fontSize}}> {getMonth(selectedDate.getMonth() + 1)} {selectedDate.getFullYear()}</Texts>
            <Row style={{}}>
